...
const ComplianceReport = () => {
  ...
  useEffect(() => {
    ...
    const mouseEnterHandlers: Record<number, () => void> = {};
  ...
  return (
    <div ref={sectionRef} className="compliance-container">
      <h2 ref={titleRef} className="section-title">Specification Compliance Report</h2>
      
      <div ref={addToRefs} className="compliance-item">
